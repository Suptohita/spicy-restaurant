    ...
    return (
        <div>
            ...
            <div className='text-center lg:mx-72 md:mx-10 mx-2 md:mt-24 mt-12 pb-24'>
                ...
                <div className='lg:mx-72 grid lg:grid-cols-3 md:grid-cols-2 pt-20 pb-48'>
                    <div>
