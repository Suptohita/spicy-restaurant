...
const FeatureDishes = () => {
    ...
    return (
        <div className='my-20'>
            ...
            <div className='flex items-center text-center lg:mx-72 md:mx-10 mx-2 overflow-y-hidden feature-dish'>
                {
                    dishes.map(dish => <div style={{height:'450px', minWidth:'310px'}} className='bg-gray-50 m-3 outline-none hover:border-yellow-500 border-transparent border-4 cursor-pointer'>
