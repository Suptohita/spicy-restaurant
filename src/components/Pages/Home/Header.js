    ...
    return (
        <div className='flex lg:flex-row flex-col-reverse justify-center lg:text-left text-center items-center md:mt-28 md:mb-20 mt-12 mb-20'>
            <div>
                ...
                <h1 className='text-xl text-gray-600 font-medium mt-9'><i className="fas fa-map-pin pt-1.5 pb-0.5 pr-2 pl-2 text-white bg-yellow-500 rounded-full"></i> 32 Annie's Road, San Andreas, Los Angeles</h1>
